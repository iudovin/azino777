  ...
  create view "datastack"."dm"."monthly_summary__dbt_tmp"
...
WITH dep AS (
    ...
    FROM "datastack"."dds"."fct_deposits" d
    JOIN "datastack"."dds"."dim_players" p ON d.player_id = p.player_id
    GROUP BY 1, 2
),
wth AS (
    SELECT 
    ...
    FROM "datastack"."dds"."fct_withdrawals" w
    JOIN "datastack"."dds"."dim_players" p ON w.player_id = p.player_id
    GROUP BY 1, 2
),
gms AS (
    SELECT 
    ...
    FROM "datastack"."dds"."fct_games" g
    JOIN "datastack"."dds"."dim_players" p ON g.player_id = p.player_id
    GROUP BY 1, 2
),
all_keys AS (
